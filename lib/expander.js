            ...
            compiler.perform(opts, arg, accum, expansion).then(
              function(result) {
                ...
                if (result instanceof Array) {
                  ...
                  copy.forEach(function(action) {
                    result.forEach(function(result) {
                      ...
                      newAction.expansion = part + result + action.expansion + first;
                    });
                  })
                  return resolve();
                }
                ...
                arg.actions.forEach(function(action) {
                  if (first == '' && part == '' 
                    && typeof action.expansion == 'undefined') action.expansion = result
                  else action.expansion = part + result + action.expansion + first;
                });
